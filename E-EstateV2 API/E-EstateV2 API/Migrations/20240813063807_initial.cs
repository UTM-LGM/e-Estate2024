        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    updatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    updatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    startFinancialYear = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    endFinancialYear = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    weightLoss = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    fieldId = table.Column<int>(type: "int", nullable: false),
                    otherCropId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    grantTitle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    grantArea = table.Column<float>(type: "real", nullable: false),
                    grantRubberArea = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    paymentStatusId = table.Column<int>(type: "int", nullable: false),
                    MSNRStatus = table.Column<bool>(type: "bit", nullable: false),
                    rubberSalesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
