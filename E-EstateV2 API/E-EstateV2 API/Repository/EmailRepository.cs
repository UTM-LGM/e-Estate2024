...
namespace E_EstateV2_API.Repository
{
    public class EmailRepository : IEmailRepository
    {
        ...
        private string GenerateHtmlResetPassword(string userId, string token)
        {
            ...
            string resetLink = $"{rrimUrl}/forgotpassword?userId={idEncoded}&token={tokenEncoded}";
        ...
        private string GenerateHtmlRegister(Email request)
        {
            ...
            string rrimUrl = _config["BaseUrls:RRIMestetApi"];
            ...
            string htmlMessage = "<html>" +
                "<body>" +
                 ...
                 "to verify your email address : <br/><br/> <a href='" + rrimUrl + "/api/emails/verifyEmail/" + plainEncoded + "'>Verify Email</a><br>" +
                 "<br>" +
                 "Thank you," +
                 "<br>" +
                 "RRIMestet Admin" +
        ...
        private string GenerateHtmlUserVerified(string userName)
        {
            ...
            string htmlMessage = "<html>" +
                ...
                "Please click <a href = '" + rrimUrl + "'>Login RRIMestet</a><br/><br/>" +
                "Thank you,<br/>" +
